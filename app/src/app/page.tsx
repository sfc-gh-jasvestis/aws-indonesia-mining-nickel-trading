  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Revenue (MTD)" value="US$420M" status="neutral" />
        <KPICard title="Avg Ni Price" value="$16,840/t" status="neutral" />
        <KPICard title="Contracts Active" value="87" status="neutral" />
        <KPICard title="HPM Compliance" value="100%" status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="LME Forecast (30d)" value="$17,200" />
        <KPICard title="China Premium" value="+$340" />
        <KPICard title="EV Demand Index" value="↑ 12%" />
      </div>
      <Chart
